...
stripe.api_key = "sk_test_51HgACrCCt0xLk7OnRUlH3aV2qZIkbWM2GakI9IRYNpjb70bFgC8cNo3x3dEuseuQkjbbarJoz6OiCrsxh8fGCMG700tLmqY9xd"
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        plan = 'price_1HgAN1CCt0xLk7OnPt5PGbT3'
        if request.POST['plan'] == 'yearly':
            plan = 'price_1HgAN1CCt0xLk7OnAQDG3muz'
        ...
        customer.stripe_subscription = subscription.id
        customer.save()
        ...
        return render(request, 'plans/checkout.html', {'plan':plan,'coupon':coupon,
        'price':price,'og_dollar':og_dollar,'coupon_dollar':coupon_dollar,'final_dollar':final_dollar})
...
def settings(request):
    ...
    if request.method == 'POST':
        subscription = stripe.Subscription.retrieve(request.user.customer.stripe_subscription)
